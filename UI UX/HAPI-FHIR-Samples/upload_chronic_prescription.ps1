# Upload Chronic Prescription Test Data
# 2 Patients with 8 FHIR Resources

$ErrorActionPreference = "Continue"
$FHIR_SERVER = "https://thas.mohw.gov.tw/v/r4/fhir"
$JSON_FILE = "Chronic_Prescription_2_Patients.json"

Write-Host "========================================"
Write-Host "Upload Chronic Prescription Test Data"
Write-Host "========================================"
Write-Host ""
