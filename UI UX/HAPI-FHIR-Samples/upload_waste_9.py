"""
上傳 9 位住院病人的廢棄物管理資料到 emr-smart FHIR 伺服器
"""
    ...
    if response.status_code in [200, 201]:
        ...
        if 'entry' in result:
            ...
            if errors:
                ...
                for i, error in enumerate(errors[:5], 1):  # 只顯示前 5 個錯誤
...
if __name__ == "__main__":
    bundle_file = "waste_9_bundle.json"
    success = upload_bundle(bundle_file)
    
    if success:
        print("\n廢棄物管理資料上傳完成!")
        print("病人編號: TW00250 - TW00258")
        print("資源總數: 45 (9 Patient + 9 Encounter + 27 Observation)")
    else:
        print("\n上傳失敗,請檢查網路連線和伺服器狀態")
